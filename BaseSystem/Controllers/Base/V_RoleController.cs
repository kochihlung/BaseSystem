...
{
    public class V_RoleController : JsonNetController
    {
        //定義主表表名
        string MainTable = "S_ROLE";
        ...
        /// </summary>
        /// <returns></returns>
        public ActionResult GetFunBase(string UID)
        {
            try
            {
                ...
                R.Dtl.Base.Col.Where(q => q.ColName == "S_MENU_ID").ToList().ForEach(o =>
                {
                    o.Required = true;//必填
                    o.UI = "Combobox";
                    o.Source = new Modling_Rule().GetComboboxData("S_MENU");
                });
