...
{
    public class V_UserRoleController : JsonNetController
    {
        //定義主表表名
        string MainTable = "S_USERROLE";
        ...
        public ActionResult GetFunBase()
        {
            try
            {
                ...
                var R = new SysService.objs.View.B_MainDtl(MainTable);//S_USERROLE----S_USERROLEDTL
                R.Text = "權限群組";
                //調整欄位屬性
                //主表
                ...
                R.Dtl.Base.Col.Where(q => q.ColName == "CODE").ToList().ForEach(o =>
                {
                    o.Required = true;//必填
                    o.UI = "Combobox";
                    o.Source = new Modling_Rule().GetComboboxData("S_ROLE");
                    o.text = "權限名稱";
                });
