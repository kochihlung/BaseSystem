...
{
    public class V_SignOwnerController : JsonNetController
    {       //定義主表表名
        string MainTable = "M_SIGNOWNER";
        ...
        public ActionResult GetFunBase()
        {
            try
            {
                ...
                var R = new SysService.objs.View.B_MainDtl(MainTable);//M_SINGOWNER----M_SINGOWNERDTL
                R.Text = "權限群組";
                //調整欄位屬性
                //主表
                ...
                R.Main.Base.Col.Where(q => q.ColName == "M_OPER_ID").ToList().ForEach(o =>
                {
                    o.Required = true;//必填
                    o.text = "節點";
                    o.UI = "Combobox";
                ...
                R.Dtl.Base.Col.Where(q => q.ColName == "S_USERINFO_ID").ToList().ForEach(o =>
                {
                    o.Required = true;//必填
                    o.UI = "Combobox";
                    o.text = "用戶";
                    o.Source = new Modling_Rule().GetComboboxData("S_USERINFO");
                });
        ...
        public ActionResult CreateMainDatas(string data)
        {
            try
            {
                ...
                var Result = Rule.CreateByDictionary(MainTable, _dic, false);
